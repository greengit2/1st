...
<!-- <script src= "resources/boardlist.js"></script> -->
 ...
 <h1>게시판 목록입니다</h1>
<input type="button" value="글쓰기" onclick="location.href='http://localhost:8080/board/write'">
<!-- <a href ="http://localhost:8080/board/write">111</a> -->
...
<table border="1">
	<tr>
		<td>게시판번호</td> <td>제목</td> <td>내용</td> <td>작성일자</td> <td>조회수</td> <td>아이디</td>
	</tr>
